...
use App\Models\Item; // Itemモデル（商品の設計図）を呼び出す
use App\Models\User; // Userモデル（会員の設計図）を呼び出す
use App\Models\Category; // ★追加：カテゴリーの住所を教える
